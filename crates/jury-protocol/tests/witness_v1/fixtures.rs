...
use jury_protocol::{
    vault_v1::{
        ...
        ItemId, LabelId, PresentationNonce, PrincipalId, ReceiptId, RecipientPublicKey1216,
        RecoveryId, RequestId, ResponseId, RevisionSealId, RotationId, SlotId, VaultId,
        WitnessPolicyId,
    ...
    witness_v1::{
        ...
        OutputSinkV1, OwnerReviewLabelV1, PlatformAssuranceV1, PolicyMaterialBytes,
        ...
        VaultHighWatermarkV1, VaultPolicyCheckpointV1, WitnessContributionEnvelopeV1,
        WitnessDecisionKindV1, WitnessDecisionV1, WitnessDescriptorBytes, WitnessOperationV1,
        ...
        WitnessRotationReasonV1, WitnessStateAnchorV1, owner_review_label_set_digest,
