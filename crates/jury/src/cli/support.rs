mod errors;
#[cfg(test)]
use errors::map_filesystem_error_kind;
pub(super) use errors::{
    map_filesystem_error, map_identity_error, map_item_error, map_mutation_commit_error,
    map_mutation_error, map_registration_error, map_secret_error,
};

use super::*;

pub(super) fn mutation_output<I>(
